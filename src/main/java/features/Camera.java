...
//    }
    ...
    public static void rescaleObjects() {
        for (Entity object : gPanel.objects.get(gPanel.currentMap)) {
            if (object instanceof SuperObject obj) {
                obj.image = UtilityTool.scaledImage(obj.originalObjImage, gPanel.tileSize, gPanel.tileSize);
            }
        }
    }
    ...
    public static void fixNPCStuckInTile() {
        for (Entity npc : gPanel.npcList.get(gPanel.currentMap)) {
